...
SECRET_KEY = 'django-insecure-v6z=2q&j9sr&=w&f7t&5=7ua6sokyhr3$d^e-304y0sf3x0osg'
...
LOGGING = {
    ...
    'loggers':{
        'django' :{
            'handlers': ['console', 'consolewarning', 'consoleerror', 'new'],
            'level': 'DEBUG',
        },
        'django.request' :{
            'handlers': ['mail_admins', 'errorslog'],
            'level': 'ERROR',
        },
        'django.server' :{
            'handlers': ['mail_admins', 'errorslog'],
